"""
Main CLI interface for WinFlux
"""
...
from .modules import CleanupModule, AnalyzeModule, OptimizeModule, ReportModule
from .config import load_config, save_config, setup_logging, CONFIG_DIR, LOG_FILE
...
def config(set_option, show):
    ...
    if show or (not set_option):
        ...
        console.print(table)
        console.print(f"\n[dim]Config file: {CONFIG_DIR / 'config.json'}[/dim]")
